...
Public Class crpReportSale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MiniProjectVB.crpReportSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpReportSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpReportSale = New crpReportSale()
        rpt.Site = Me.Site
        Return rpt
    End Function

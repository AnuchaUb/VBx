...
Public Class crpReportStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MiniProjectVB.crpReportStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpReportStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpReportStock = New crpReportStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
